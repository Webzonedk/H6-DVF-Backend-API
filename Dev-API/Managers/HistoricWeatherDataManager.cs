...
namespace Dev_API.Managers
{
    ...
    public class HistoricWeatherDataManager
    {
        ...
        private float[] ConvertDateTimeToFloatArray(string[] timeArray)
        {
            return timeArray.Select(time => ConvertDateTimeToFloat(time)).ToArray();
        }

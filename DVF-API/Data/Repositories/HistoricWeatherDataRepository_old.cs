...
{
    public class HistoricWeatherDataRepository_old : IHistoricWeatherDataRepository
    {
        ...
        #region Constructors
        public HistoricWeatherDataRepository_old(IConfiguration configuration, IUtilityManager utilityManager)
        {
